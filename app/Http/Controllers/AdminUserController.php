...
class AdminUserController extends Controller
{
    ...
    {
        $projetencours = Projet::where('etat', 2)->get();
        $projets_termines = Projet::where('etat', 3)->get();
        $simpleUsers = User::where('google_token', null)->get();
        $googleUsers = User::where('google_token',  '!=', null)->get();
        

        return view('wp-admin/pages/charts', ['projetencours' => $projetencours, 'projets_termines' => $projets_termines, 'simpleUsers' => $simpleUsers, 'googleUsers' => $googleUsers]);
    }
