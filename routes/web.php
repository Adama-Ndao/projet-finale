...
Route::get('wp-admin/pages/create', [UserController::class, 'create'])->name('wp-admin/pages.create');
Route::post('wp-admin/pages', [UserController::class, 'store'])->name('wp-admin/pages.store');
