          ...
          <li class="nav-item profile">
            <div class="profile-desc">
              <div class="profile-pic">
                ...
                <img class="img-xs rounded-circle" src="{{ asset('src/assets/images/logos/' . Auth::user()->photo) }}" alt="">
          ...
          <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
            ...
            <ul class="navbar-nav navbar-nav-right">
              <li class="nav-item dropdown d-none d-lg-block">
                <a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-toggle="dropdown" aria-expanded="false" href="http://127.0.0.1:8000/user/create">+ Create New User</a>
