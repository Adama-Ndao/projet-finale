              ...
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h6 class="text-muted font-weight-normal">Nombre d'utilisateurs</h6>
                  </div>
                </div>
              </div>
              <!-- partie nbr_projets -->
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h6 class="text-muted font-weight-normal">Nombre de projets</h6>
                  </div>
                </div>
              </div>
               <!-- partie nbr_projetsencours -->
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0">{{ $nbr_projetencours }}</h3>
                        </div>
                      </div>
                      <div class="col-3">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0">{{ $nbr_projetstermines }}</h3>
                        </div>
                      </div>
                      <div class="col-3">
                        <div class="icon icon-box-success ">
                          <span class="mdi mdi-progress-check icon-item"></span>
                        </div>
                      </div>
                    </div>
                    <h6 class="text-muted font-weight-normal">Projets termines</h6>
                  </div>
                </div>
              </div>
            </div>
