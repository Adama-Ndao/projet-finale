            ...
            <div>
                <div class="brand-logo d-flex align-items-center justify-content-between">
                    <a href="http://127.0.0.1:8000/" class="text-nowrap logo-img">
                        <img src="{{ asset('src/assets/images/logos/logotaskeasy.png') }}" width="100"
                            alt="" />
                    </a>
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="/addtask" aria-expanded="false">
                                ...
                                <span
                                    class="hide-menu">Ajouter un projet</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="/listtask" aria-expanded="false">
                                ...
                                <span
                                    class="hide-menu">Liste des projets</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="/taskencours" aria-expanded="false">
                                ...
                                <span
                                    class="hide-menu">Projets en cours</span>
                            </a>
                        </li>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="./finishtask" aria-expanded="false">
                                ...
                                <span
                                    class="hide-menu">Projets terminés</span>
                            </a>
                        </li>
                        <li class="nav-small-cap">
                            <i class="ti ti-dots nav-small-cap-icon fs-4"></i>
                            <span
                                class="hide-menu">Collaborations</span>
                        </li>
                        <li class="sidebar-item">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="http://127.0.0.1:8000/yomibot" aria-expanded="false">
                                ...
                                <span class="hide-menu">Yomi', app()->getLocale()) }}</span>
                            </a>
                    </ul>
                    <div class="unlimited-access hide-menu bg-light-primary position-relative mb-7 mt-5 rounded">
                        <div class="d-flex">
                            <div class="unlimited-access-title me-3">
                                ...
                                <a href="http://127.0.0.1:8000/versionpro#" target="_blank"
                                    class="btn btn-primary fs-2 fw-semibold lh-sm ">disponible</a>
                            </div>
                            <div class="unlimited-access-img">
                                <img src="{{ asset('src/assets/images/backgrounds/rocket.png') }}" alt=""
                                    class="img-fluid">
                            </div>
                        </div>
                    </div>
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2"
                                    ...
                                    @if (empty(Auth::user()->photo))
                                        <img src="{{ asset('src/assets/images//logos/user-1.jpg') }}" alt=""
                                            width="35" height="35" class="rounded-circle">
                                    @else
                                        <img src="{{ asset('src/assets/images/logos/' . Auth::user()->photo) }}"
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up"
                                    ...
                                    <div class="message-body">
                                        ...
                                        <button type="button" class="d-flex align-items-center gap-2 dropdown-item"
            ...
            <form method="POST" action="{{ route('password.verify') }}">
                ...
                <div class="modal-footer">
                    <button class="btn btn-danger"
                        onclick="clearFields()">Effacer</button>
                    <button type="submit"
                        class="btn btn-success">Continuer</button>
                </div>
            </form>
        </div>
    </div>
