...
<!------------------------------------------------------------------------------------------------------------------------------------------------------>
  ...
  <script>
    ...
    var enCoursPourcentage = (enCours.length / totalProjets) * 100;
    var terminesPourcentage = (termines.length / totalProjets) * 100;

    var data = {
        labels: ['En cours', 'Terminés'],
        datasets: [{
            label: 'Pourcentage de projets',
            data: [enCoursPourcentage.toFixed(2), terminesPourcentage.toFixed(2)],
        ...
        options: {
            scales: {
                y: {
                    beginAtZero: true,
                    precision: 0,
                    // Modifier l'étiquette de l'axe Y pour afficher les pourcentages
